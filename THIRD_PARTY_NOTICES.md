...
React Leaflet 5.0.0 uses the Hippocratic License 2.1 rather than MIT. Its
upstream license is available at:
https://github.com/PaulLeCam/react-leaflet/blob/v5.0.0/LICENSE.md

Review the upstream license when distributing artifacts that contain React
Leaflet code.
